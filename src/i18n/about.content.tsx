export default {
  fr: {
    ...
    specialties: {
      ctf: {
        ...
        description: "Résolution de défis de sécurité et compétitions"
      },
      honeypot: {
        title: "Honeypots",
  ...
  en: {
    ...
    specialties: {
      ctf: {
        title: "CTF & Challenges",
        description: "Security challenge solving and competitions"
      },
      honeypot: {
        title: "Honeypots",
        description: "Developing traps to analyze attacks"
      },
      security: {
        title: "Offensive Security",
        description: "Penetration testing and vulnerability exploitation"
      }
    },
    terminal: {
      command: "whoami --detailed",
